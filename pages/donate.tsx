...
export default function Donate() {
    return (
        <>
            <div className='xl:mx-auto xl:container 2xl:px-0'>
                <div className='items-center justify-between lg:flex'>
                    ...
                    <div className='relative w-full mt-12 xl:w-1/2 lg:w-7/12 lg:mt-0 md:px-8' role='list'>
                        <Link href='https://github.com/sponsors/tidev' target='_blank' className='no-underline'>
                            <div role='listitem' className='relative z-30 p-8 bg-white rounded-lg shadow cursor-pointer dark:bg-neutral-600 hover:bg-gray-200 hover:dark:bg-neutral-700'>
                                ...
                                <p className='mt-4 text-base leading-6 text-gray-600 md:w-100 dark:text-gray-200'>Choose between different tiers or a custom payment</p>
                            </div>
                        </Link>
                        <Link href='https://liberapay.com/tidev/' target='_blank' className='no-underline'>
