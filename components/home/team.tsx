...
export default function Team() {
    return (
        <>
            <div className='space-y-12 md:text-center mt-20'>
            ...
            <div className='grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3'>
                <div className='w-full border border-gray-200 rounded-lg shadow-sm'>
                    <div className='flex flex-col items-center justify-center p-10'>
                        <Image src='/board/josh.png' alt='Josh Lambert' className='w-32 h-32 mb-6 rounded-full' width={128} height={128} />
                        <h2 className='text-lg font-medium'>Josh Lambert</h2>
                        <p className='font-medium text-blue-500 text-center'>CEO of Centreville Tech LLC</p>
                        <p className='text-gray-400'>Board chairman</p>
                    </div>
