            ...
            <div className='grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16 px-10'>
                <div>
                    <div className='flex items-center pr-2 mb-3'>
                        <svg className='w-8 h-8 text-blue-500' aria-hidden='true' fill='currentColor' viewBox='0 0 448 512' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <div className='flex items-center pr-2 mt-10 mb-3'>
                        <svg className='w-8 h-8 text-blue-500' aria-hidden='true' fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 512'>
                    ...
                    <p>This means marketing the free support provided via Slack and StackOverflow, as well as creating a paid enterprise support channel enabling large corporations to purchase dedicated support for the SDK from our core engineers.</p>
                </div>
                <div>
                    <div className='flex items-center pr-2 mb-3'>
                        <svg className='w-8 h-8 text-blue-500' aria-hidden='true' fill='currentColor' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
