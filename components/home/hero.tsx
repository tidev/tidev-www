            ...
            <div className='py-12 text-center px-10'>
                ...
                <div className='flex justify-center'>
                    <Link href='https://titaniumsdk.com' passHref>
                        <a target='_blank' className='px-8 py-3 my-5 font-semibold rounded bg-blue-500 hover:bg-blue-700 text-white'>
                            Learn the API
                        </a>
                    </Link>
                    <Link href='/donate'>
                        <a className='ml-5 px-8 py-3 my-5 font-semibold rounded bg-blue-500 hover:bg-blue-700 text-white'>Donate</a>
                    </Link>
                </div>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-12 py-10 px-10'>
                <div className='py-5 text-center'>
                    <div className='group inline-flex items-center justify-center w-12 h-12 ml-3 mb-8 relative'>
                        ...
                        <div className='absolute inset-0 rounded-xl -m-3 transform rotate-2 bg-blue-500 bg-opacity-75 shadow-inner transition ease-out duration-150 group-hover:-rotate-3 group-hover:scale-110'></div>
