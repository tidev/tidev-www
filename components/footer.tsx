            ...
            <div className='max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8'>
                <nav className='flex flex-wrap justify-center -mx-5 -my-2'>
                    <div className='px-5 py-2'>
                        <Link href='/legal' className='text-sm leading-6 text-gray-500 dark:text-gray-200 hover:text-blue-500'>Legal</Link>
                    </div>
                    <div className='px-5 py-2'>
                        <Link href='/code-of-conduct' className='text-sm leading-6 text-gray-500 dark:text-gray-200 hover:text-blue-500'>Code of conduct</Link>
                    </div>
                </nav>
