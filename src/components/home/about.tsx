            ...
            <div className='grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16'>
                <div>
                    <div className='flex items-center pr-2 mb-3'>
                        ...
                        <h5 className='ml-3 font-semibold'>To ensure the Titanium SDK is actively maintained and developed for years to come</h5>
                    </div>
                    ...
                    <div className='flex items-center pr-2 mt-10 mb-3'>
                        ...
                        <h5 className='ml-3 font-semibold'>To create a trusted channel for getting support around the platform</h5>
                    </div>
                    <p>
                        <span>This means marketing the free support provided via </span>
                        <Link href='https://slack.tidev.io' target='_blank'>Slack</Link>
                        <span> and </span>
                        <Link href='https://stackoverflow.com/questions/tagged/titanium' target='_blank'>StackOverflow</Link>
                ...
                <div>
                    <div className='flex items-center pr-2 mb-3'>
                        ...
                        <h5 className='ml-3 font-semibold'>To improve the reputation of the Titanium ecosystem</h5>
                    </div>
                    ...
                    <div className='flex items-center pr-2 mt-10 mb-3'>
                        ...
                        <h5 className='ml-3 font-semibold'>To actively grow the Titanium developer community</h5>
                    </div>
